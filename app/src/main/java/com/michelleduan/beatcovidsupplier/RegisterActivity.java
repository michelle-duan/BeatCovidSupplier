...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateAccount()
    {
        ...
        else
        {
            ...
            ValidateUsername(username, email, password);
        }
    }
    ...
    private void ValidateUsername(final String username, final String email, final String password)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                {
                    Toast.makeText(RegisterActivity.this, "This user is already taken.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this, "Please register using another username.", Toast.LENGTH_SHORT).show();
