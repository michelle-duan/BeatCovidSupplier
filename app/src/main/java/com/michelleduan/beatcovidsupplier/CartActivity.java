...
import com.michelleduan.beatcovidsupplier.Model.Cart;
import com.michelleduan.beatcovidsupplier.Prevalent.Prevalent;
import com.michelleduan.beatcovidsupplier.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Congratulations, your order has been Shipped successfully. Soon you will received your order at your door step.");
